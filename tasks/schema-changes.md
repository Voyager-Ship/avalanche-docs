...
_Auto-generated 2026-05-13 — `feat/standardize-evaluate-hackathon` vs `fc00d9027bf0`_
...
flowchart LR
    ...
    User["<b>User</b><br/>id : String PK<br/>name : String?<br/>email : String<br/>image : String?<br/>authentication_mode : String?<br/>integration : String?<br/>last_login : DateTime?<br/>user_name : String?<br/>bio : String?<br/>notification_email : String?<br/>notifications : Boolean?<br/>profile_privacy : String?<br/>social_media : String[]<br/>custom_attributes : String[]<br/>team_id : String?<br/>telegram_user : String?<br/>created_at : DateTime<br/>country : String?<br/>github : String?<br/>noun_avatar_enabled : Boolean<br/>noun_avatar_seed : Json?<br/>skills : String[]<br/>user_type : Json?<br/>wallet : String[]<br/>notification_means : Json?<br/>github_access_token : String?"]:::existing
