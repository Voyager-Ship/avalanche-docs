...
export default async function HackathonJudgesPage({
  ...
  return (
    <main className="container relative px-4 py-8 lg:py-16">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-zinc-100">Judges</h1>
        <p className="mt-1 text-sm text-zinc-400">
          Manage judges for <span className="text-zinc-200">{hackathon.title}</span>.
          Judges can view this hackathon&apos;s projects in the evaluate dashboard
          and submit a score + comment per project.
        </p>
      </div>
      <JudgesManager
